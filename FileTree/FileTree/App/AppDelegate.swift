...
var window: UIWindow?
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    let navigationController = UINavigationController(rootViewController: ItemAddingController(itemType: .file, parentUUID: "55382859-D5F5-4A12-8AD6-308389929F56", networkManager: RequestsManager()))
